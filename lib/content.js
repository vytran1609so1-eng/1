...
export const defaultSettings = {
  ...
  about: {
    ...
    title: "About me",
    lead:
      "The parts that do not fit on a CV — where I have been, what I keep coming back to, and the people I did it with.",
    milestones: [],
  },
  ...
  blog: {
    ...
    title: "Blog",
    lead:
      "Nơi tôi viết dài hơn một dòng CV — về fintech, về những thứ đang học, và về vài chuyện ngoài lề.",
    categories: [
